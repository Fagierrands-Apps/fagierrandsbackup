...
urlpatterns = [
    ...
    path('clients/all/', views.AllClientsListView.as_view(), name='all_clients_list'),
    ...
    # Handler create user endpoint
    path('handler/create-user/', views.handler_create_user, name='handler_create_user'),
]
