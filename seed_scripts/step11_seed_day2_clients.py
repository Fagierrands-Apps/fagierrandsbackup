...
new_users = [
    ("niapetals", "Nia", "Petals", "niapetals@fagierrands.com", ""),
    ("platinumplaza", "Platinum", "Plaza", "platinumplaza@fagierrands.com", ""),
    ("michaelsbouquet", "Micheals", "Bouquette", "michaelsbouquet@fagierrands.com", ""),
    ("yyvonne", "Yyvonne", "Jitihada", "yyvonne@fagierrands.com", ""),
]

for username, first, last, email, phone in new_users:
    print(f"\n>>> Seeding {username}...")
    psql(f"""
        ...
        VALUES
            ('!disabled', NULL, false, '{username}', '{first}', '{last}',
    ...
    psql(f"""
        ...
        SELECT '', '', id, 0, 0 FROM accounts_user WHERE username='{username}';
    """)
