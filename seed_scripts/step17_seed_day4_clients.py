...
for username, first, last, email in [
    ("athiambothrift", "Athiambo", "Thrift", "athiambothrift@fagierrands.com"),
    ("sambranding", "Sam", "Branding", "sambranding@fagierrands.com"),
]:
...
# Get their IDs
print("\n=== NEW CLIENT IDs ===")
psql("SELECT id, username FROM accounts_user WHERE username IN ('athiambothrift','sambranding');")
