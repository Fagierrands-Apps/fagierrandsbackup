...
new_users = [
    ("dyaminc", "Dyaminc", "Queens Choice", "dyaminc@fagierrands.com"),
    ("epichumanhair", "Epic", "Human Hair", "epichumanhair@fagierrands.com"),
    ("essylanjeweleries", "Essylan", "Jeweleries", "essylanjeweleries@fagierrands.com"),
    ("gathu", "Gathu", "", "gathu@fagierrands.com"),
    ("hakatibusiness", "Hakati", "Business Centre", "hakatibusiness@fagierrands.com"),
    ("wanjira", "Wanjira", "", "wanjira@fagierrands.com"),
]

for username, first, last, email in new_users:
