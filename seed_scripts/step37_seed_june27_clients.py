...
for username, first, last, email in [
    ("lornak", "Lornak", "", "lornak@fagierrands.com"),
    ("vanessa", "Vanessa", "", "vanessa@fagierrands.com"),
]:
...
psql("SELECT id, username FROM accounts_user WHERE username IN ('lornak','vanessa');")
