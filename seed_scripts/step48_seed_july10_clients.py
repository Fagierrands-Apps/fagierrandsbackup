...
new_clients = [
    ("mtindongara",  "Mtindo",  "Ngara",   "mtindongara@fagierrands.com",  "726620888"),
...
print("\n>>> Final IDs:")
psql("SELECT id, username FROM accounts_user WHERE username IN ('mtindongara','queensrng','nancylisters','kwamwalimu','tonysangura') ORDER BY id;")
