...
new_clients = [
    ...
    ("genuinekunga",    "Genuine", "Kunga",           "genuinekunga@fagierrands.com",   "722604711"),
...
print("\n>>> Final IDs:")
psql("SELECT id, username FROM accounts_user WHERE username IN ('nolanskids','linayarn','joybusiness','genuinekunga','baddiesempire') ORDER BY id;")
