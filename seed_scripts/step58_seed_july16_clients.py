...
new_clients = [
    ...
    ("tangecollect", "Tange",   "Collection",    "tangecollect@fagierrands.com","714348056"),
    ("kimathihouse", "Kimathi", "House",         "kimathihouse@fagierrands.com","798286199"),
    ("oderovictor",  "Odero",   "Kevin",         "oderovictor@fagierrands.com", "712445305"),
...
print("\n>>> Final IDs:")
psql("SELECT id, username FROM accounts_user WHERE username IN ('rebune','tangecollect','kimathihouse','oderovictor','nashique','miyannegifts','fashionfix') ORDER BY id;")
