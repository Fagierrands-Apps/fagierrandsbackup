...
new_clients = [
    ("halimaderafashions", "Halima", "Dera", "halimaderafashions@fagierrands.com", "795118132"),
    ("randlandings",       "Rand",   "Landings", "randlandings@fagierrands.com",   "714348056"),
]
...
print("\n>>> Final IDs:")
psql("SELECT id, username FROM accounts_user WHERE username IN ('halimaderafashions','randlandings') ORDER BY id;")
