...
new_clients = [
    ("linetcollection", "Linet", "Collection", "linetcollection@fagierrands.com", "727405963"),
]
...
print("\n>>> Final IDs:")
psql("SELECT id, username FROM accounts_user WHERE username IN ('linetcollection') ORDER BY id;")
