...
new_clients = [
    ("nmperfumes", "NM",     "Perfumes", "nmperfumes@fagierrands.com", "710515777"),
    ("sandraclient", "Sandra", "Client", "sandraclient@fagierrands.com", ""),
]
...
print("\n>>> Final IDs:")
psql("SELECT id, username FROM accounts_user WHERE username IN ('nmperfumes','sandraclient') ORDER BY id;")
