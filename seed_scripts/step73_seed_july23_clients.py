...
new_clients = [
    ("rngplaza",       "RNG",      "Plaza",    "rngplaza@fagierrands.com",      "745158721"),
    ("michaelstomboya","Micheals", "TomMboya", "michaelstomboya@fagierrands.com","794775593"),
]
...
print("\n>>> Final IDs:")
psql("SELECT id, username FROM accounts_user WHERE username IN ('rngplaza','michaelstomboya') ORDER BY id;")
