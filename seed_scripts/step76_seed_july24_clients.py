...
new_clients = [
    ("pramukh",   "Pramukh", "Plaza", "pramukh@fagierrands.com", "702798298"),
    ("joeclient", "Joe",     "Client","joeclient@fagierrands.com", ""),
]
...
print("\n>>> Final IDs:")
psql("SELECT id, username FROM accounts_user WHERE username IN ('pramukh','joeclient') ORDER BY id;")
