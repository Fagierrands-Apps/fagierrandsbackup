...
new_clients = [
    ("whereke",    "Where",  "Ke",     "whereke@fagierrands.com",    "714352229"),
    ("shizzthrift","Shizz",  "Thrift", "shizzthrift@fagierrands.com","790182722"),
]
...
print("\n>>> Final IDs:")
psql("SELECT id, username FROM accounts_user WHERE username IN ('whereke','shizzthrift') ORDER BY id;")
